...
<body>
				...
				<div class="carousel-inner" role="listbox">
					<div class="carousel-item active">
						<div class="carousel-caption text-center">
							...
							<a href="?controller=product" class="btn btn-sm animated-button gibson-three mt-4">Shop Now</a>
						</div>
					</div>
						...
						<div class="product-googles-info googles">
							<div class="men-pro-item">
								<div class="men-thumb-item">
									<img src="Public/client/images/<?=$product['images']?>" class="img-fluid" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="?controller=detail&id=<?=$product['id']?>" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
									...
									<div class="info-product-price">
										<div class="grid_meta">
											<div class="product_price">
												<h4>
													<a href="?controller=detaile&id=<?=$product['id']?>"><?=$product['name']?></a>
												</h4>
											...
											<ul class="stars">
												<?php $star=1; while ($star <= $product['rate']) { ?>
												<li><a href="?controller=detail&id=<?=$product['id']?>"><i class="fa fa-star active" aria-hidden="true"></i></a></li>
												<?php $star++;} ?>
												<?php  while ($star <= 5) { ?>
												<li><a href="?controller=detail&id=<?=$product['id']?>"><i class="fa fa-star" aria-hidden="true"></i></a></li>
												<?php $star++;} ?>
											</ul>
										</div>
										<div class="googles single-item hvr-outline-out">
											<a href="javascript:addcart(<?php echo $product['id']; ?>);">
												<button type="submit" class="googles-cart pgoogles-cart">
													<i class="fas fa-cart-plus"></i>
												</button>
											</a>
											<?php if (isset($_SESSION['user'])): ?>
											<div id="product-favourite" class="<?php if(isset($product['favourite'])) echo 'product-favourite-active' ?>" data-id="<?=$stt?>">
			                                    <a href="javascript:favourite(<?=$stt?>,<?=$product['id']?>);" ><i class="fas fa-heart"></i></a>
			                                </div>
			                            <?php endif ?>
				...
				<div class="row galsses-grids pt-lg-5 pt-3">
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="Public/client/images/banner4.jpg" alt="" class="img-fluid">
							<figcaption>
								<h3>Editor's
									<span>Pick</span>
								</h3>
					...
					<div class="col-lg-6 galsses-grid-left">
						<figure class="effect-lexi">
							<img src="Public/client/images/banner1.jpg" alt="" class="img-fluid">
							<figcaption>
								<h3>Editor's
									<span>Pick</span>
								</h3>
	...
	<!-- carousel -->
	<!-- Count-down -->
	<script src="Public/client/js/simplyCountdown.js"></script>
	<link href="Public/client/css/simplyCountdown.css" rel='stylesheet' type='text/css' />
	<script>
		var d = new Date();
